...
namespace nts
{
    ...
    {
        name = "4001";
        gates[1] = std::unique_ptr<IComponent>(new NORComponent());
        ...
        gates[2] = std::unique_ptr<IComponent>(new NORComponent());
        ...
        gates[3] = std::unique_ptr<IComponent>(new NORComponent());
        ...
        gates[4] = std::unique_ptr<IComponent>(new NORComponent());
