...
namespace nts
{
    ...
    {
        name = "4081";
        gates[1] = std::unique_ptr<IComponent>(new ANDComponent());
        ...
        gates[2] = std::unique_ptr<IComponent>(new ANDComponent());
        ...
        gates[3] = std::unique_ptr<IComponent>(new ANDComponent());
        ...
        gates[4] = std::unique_ptr<IComponent>(new ANDComponent());
