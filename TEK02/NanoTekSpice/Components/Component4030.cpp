...
namespace nts
{
    ...
    {
        name = "4030";
        gates[1] = std::unique_ptr<IComponent>(new XORComponent());
        ...
        gates[2] = std::unique_ptr<IComponent>(new XORComponent());
        ...
        gates[3] = std::unique_ptr<IComponent>(new XORComponent());
        ...
        gates[4] = std::unique_ptr<IComponent>(new XORComponent());
