...
namespace nts
{
    ...
    {
        name = "4071";
        gates[1] = std::unique_ptr<IComponent>(new ORComponent());
        ...
        gates[2] = std::unique_ptr<IComponent>(new ORComponent());
        ...
        gates[3] = std::unique_ptr<IComponent>(new ORComponent());
        ...
        gates[4] = std::unique_ptr<IComponent>(new ORComponent());
