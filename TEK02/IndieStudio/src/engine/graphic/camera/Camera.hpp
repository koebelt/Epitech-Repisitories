...
namespace istudio {
    namespace graphic {
        ...
        class Camera {
            public:
                Camera(math::Vector3 position = math::Vector3(0.0f, 0.0f, 0.0f), math::Vector3 target = math::Vector3(1.0f, 0.0f, 0.0f), math::Vector3 up = math::Vector3(0.0f, 1.0f, 0.0f), float fovy = 45.f, int projection = CameraProjection::PERSPECTIVE);
                ~Camera() = default;
