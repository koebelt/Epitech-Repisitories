...
namespace zappy
{
    namespace graphic
    {
        Skybox::Skybox(std::string filename)
        {
            ...
            int as[1] = {0};
            int ass[1] = {1};
            _skybox.materials[0].shader = LoadShader("./GUI/assets/skybox.vs", "./GUI/assets/skybox.fs");
            ...
            Shader shdrCubemap = LoadShader("./GUI/assets/cubemap.vs", "./GUI/assets/cubemap.fs");
